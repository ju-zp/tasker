...
//go:generate swagger generate server --target ../../tasker --name Tasker --spec ../../../../swagger.yml --principal interface{} --exclude-main
...
func configureAPI(api *operations.TaskerAPI) http.Handler {
	...
	if api.DeleteProjectHandler == nil {
		api.DeleteProjectHandler = operations.DeleteProjectHandlerFunc(func(params operations.DeleteProjectParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.DeleteProject has not yet been implemented")
		})
	}
	...
	if api.GetProjectHandler == nil {
		api.GetProjectHandler = operations.GetProjectHandlerFunc(func(params operations.GetProjectParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetProject has not yet been implemented")
		})
	}
